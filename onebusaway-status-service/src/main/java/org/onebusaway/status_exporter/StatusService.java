...
public class StatusService {
  ...
  public static final String PROVIDERS_NAME = "org.onebusaway.status_exporter.StatusService.providers";

  private Set<StatusProviderService> _providers;

  @Inject
  public void setProviders(@Named(PROVIDERS_NAME)
  Set<StatusProviderService> providers) {
